import sys # added to be able to make sure the program terminates after use.
import tkinter as tk #GUI
from tkinter import ttk #GUI
import matplotlib #Display tool
matplotlib.use("TkAgg") #Display compatibility control for maximized window view
import matplotlib.pyplot as plt #Display tool 
import numpy as np #math/scientific tool
from matplotlib.patches import Arc # creating arcs in matplotlib addon
